...
const departmentSlugs = {
  ...
  牙科: "dentistry",
  兒科: "pediatrics",
  兒童心智科: "child-psychiatry",
  內分泌新陳代謝科: "endocrinology-metabolism",
  婦產科: "obstetrics-gynecology",
  乳房外科: "breast-surgery",
  大腸直腸外科: "colorectal-surgery",
  免疫風濕科: "immunology-rheumatology",
...
const departmentDescriptions = {
  ...
  牙科: "評估牙痛、牙齦、口腔黏膜與顳顎關節相關問題。",
  兒科: "評估兒童發燒、咳嗽、腹瀉、發育與常見兒童症狀。",
  兒童心智科: "評估兒童發展、情緒、注意力與學習相關困擾。",
  內分泌新陳代謝科: "評估血糖、甲狀腺、體重變化與荷爾蒙相關症狀。",
  婦產科: "評估月經、骨盆腔、懷孕、更年期與女性健康問題。",
  乳房外科: "評估乳房腫塊、乳房疼痛與乳房感染等問題。",
  大腸直腸外科: "評估肛門直腸出血、血便與大腸直腸相關疾病。",
  免疫風濕科: "評估免疫異常、反覆感染、自體免疫與風濕相關症狀。",
